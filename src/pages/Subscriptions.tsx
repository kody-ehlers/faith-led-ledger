...
/**
 * Get the amount for a subscription entry for a specific date, accounting for variable prices.
 */
function getAmountForDate(entry: SubscriptionEntry, date: Date): number {
